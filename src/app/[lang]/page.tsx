        ...
        <div className="max-w-7xl mx-auto px-4 py-12 md:py-24">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href={`/${lang}/guides`} className="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold flex items-center justify-center hover:bg-gray-50">
                <AlertTriangle className="mr-2" />
                Emergency Guide
              </Link>
              <Link href={`/${lang}/directory`} className="bg-blue-500 text-white px-6 py-3 rounded-lg font-semibold flex items-center justify-center hover:bg-blue-600">
